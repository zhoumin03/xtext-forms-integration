...
/**
 * This is the item provider adapter for a {@link org.eclipse.xtext.example.domainmodel.DomainModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainModelItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainmodelPackage.Literals.DOMAIN_MODEL__ELEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainmodelPackage.Literals.DOMAIN_MODEL__ELEMENTS,
				 DomainmodelFactory.eINSTANCE.createAbstractElement()));

		newChildDescriptors.add
			(createChildParameter
				(DomainmodelPackage.Literals.DOMAIN_MODEL__ELEMENTS,
				 DomainmodelFactory.eINSTANCE.createImport()));
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainmodelPackage.Literals.DOMAIN_MODEL__ELEMENTS,
				 DomainmodelFactory.eINSTANCE.createType()));

		newChildDescriptors.add
			(createChildParameter
				(DomainmodelPackage.Literals.DOMAIN_MODEL__ELEMENTS,
				 DomainmodelFactory.eINSTANCE.createDataType()));
