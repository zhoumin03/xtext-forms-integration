...
/**
 * This is the item provider adapter for a {@link org.eclipse.xtext.example.domainmodel.TypeRef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeRefItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypeRef_referenced_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypeRef_referenced_feature", "_UI_TypeRef_type"),
				 DomainmodelPackage.Literals.TYPE_REF__REFERENCED,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addMultiPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypeRef_multi_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypeRef_multi_feature", "_UI_TypeRef_type"),
				 DomainmodelPackage.Literals.TYPE_REF__MULTI,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_TypeRef_type") + " " + typeRef.isMulti();
	}
