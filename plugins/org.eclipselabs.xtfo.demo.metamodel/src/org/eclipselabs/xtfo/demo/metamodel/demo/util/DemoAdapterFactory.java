 ...
 * $Id$
 */
package org.eclipselabs.xtfo.demo.metamodel.demo.util;
...
public class DemoAdapterFactory extends AdapterFactoryImpl {
	...
	protected DemoSwitch<Adapter> modelSwitch =
		new DemoSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDomainModelWrapper(DomainModelWrapper object) {
				return createDomainModelWrapperAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipselabs.xtfo.demo.metamodel.demo.Model <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipselabs.xtfo.demo.metamodel.demo.DomainModelWrapper <em>Domain Model Wrapper</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipselabs.xtfo.demo.metamodel.demo.ArithmeticWrapper <em>Arithmetic Wrapper</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
