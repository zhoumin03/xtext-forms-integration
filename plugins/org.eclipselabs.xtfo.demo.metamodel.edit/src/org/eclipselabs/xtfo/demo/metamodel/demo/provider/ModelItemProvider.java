...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.xtfo.demo.metamodel.demo.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DemoPackage.Literals.MODEL__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DemoPackage.Literals.MODEL__DOMAIN_MODELS);
			childrenFeatures.add(DemoPackage.Literals.MODEL__ARITHMETICS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		DomainModelWrapper dmw = DemoFactory.eINSTANCE.createDomainModelWrapper();
		dmw.setAstRootElement(DomainmodelFactory.eINSTANCE.createDomainModel());
		
		newChildDescriptors.add
			(createChildParameter
				(DemoPackage.Literals.MODEL__DOMAIN_MODELS,
						dmw));

		ArithmeticWrapper aw = DemoFactory.eINSTANCE.createArithmeticWrapper();
		aw.setEval(ArithmeticsFactory.eINSTANCE.createEvaluation());
		
		newChildDescriptors.add
			(createChildParameter
				(DemoPackage.Literals.MODEL__ARITHMETICS,
				 aw));
	}
