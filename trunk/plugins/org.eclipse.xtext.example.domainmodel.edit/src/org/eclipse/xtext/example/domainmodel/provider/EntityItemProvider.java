...
/**
 * This is the item provider adapter for a {@link org.eclipse.xtext.example.domainmodel.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainmodelPackage.Literals.ENTITY__FEATURES,
				 DomainmodelFactory.eINSTANCE.createStructuralFeature()));

		newChildDescriptors.add
			(createChildParameter
				(DomainmodelPackage.Literals.ENTITY__FEATURES,
				 DomainmodelFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(DomainmodelPackage.Literals.ENTITY__FEATURES,
				 DomainmodelFactory.eINSTANCE.createReference()));
