...
public class DemoSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DemoPackage.DOMAIN_MODEL_WRAPPER: {
				DomainModelWrapper domainModelWrapper = (DomainModelWrapper)theEObject;
				T result = caseDomainModelWrapper(domainModelWrapper);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DemoPackage.ARITHMETIC_WRAPPER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Domain Model Wrapper</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Domain Model Wrapper</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDomainModelWrapper(DomainModelWrapper object) {
		return null;
	}
