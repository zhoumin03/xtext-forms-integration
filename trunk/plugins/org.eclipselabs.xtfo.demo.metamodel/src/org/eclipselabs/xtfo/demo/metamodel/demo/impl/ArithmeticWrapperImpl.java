 ...
 * <ul>
 *   <li>{@link org.eclipselabs.xtfo.demo.metamodel.demo.impl.ArithmeticWrapperImpl#getAsString <em>As String</em>}</li>
 *   <li>{@link org.eclipselabs.xtfo.demo.metamodel.demo.impl.ArithmeticWrapperImpl#getEval <em>Eval</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArithmeticWrapperImpl extends EObjectImpl implements ArithmeticWrapper {
	...
	protected EClass eStaticClass() {
		return DemoPackage.Literals.ARITHMETIC_WRAPPER;
	}
	...
	public void setAsString(String newAsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DemoPackage.ARITHMETIC_WRAPPER__AS_STRING, oldAsString, asString));
	}
	...
	public NotificationChain basicSetEval(Evaluation newEval, NotificationChain msgs) {
		...
		eval = newEval;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DemoPackage.ARITHMETIC_WRAPPER__EVAL, oldEval, newEval);
	...
	public void setEval(Evaluation newEval) {
		if (newEval != eval) {
			...
			if (eval != null)
				msgs = ((InternalEObject)eval).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DemoPackage.ARITHMETIC_WRAPPER__EVAL, null, msgs);
			if (newEval != null)
				msgs = ((InternalEObject)newEval).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DemoPackage.ARITHMETIC_WRAPPER__EVAL, null, msgs);
			msgs = basicSetEval(newEval, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DemoPackage.ARITHMETIC_WRAPPER__EVAL, newEval, newEval));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DemoPackage.ARITHMETIC_WRAPPER__EVAL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DemoPackage.ARITHMETIC_WRAPPER__AS_STRING:
				return getAsString();
			case DemoPackage.ARITHMETIC_WRAPPER__EVAL:
				return getEval();
		}
